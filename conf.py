...
BLOG_TITLE = "SuperGIS"  # (translatable)
...
LOGO_URL = 'themes\zen\assets\images\Logo.svg'
...
# before </head>
# (translatable)
EXTRA_HEAD_DATA = "<meta name='viewport' content='width=device-width, initial-scale=1'>"
